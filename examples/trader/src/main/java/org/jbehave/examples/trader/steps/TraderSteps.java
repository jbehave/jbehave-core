...
/**
 * POJO holding the candidate steps for the trader example. The {@link CandidateSteps} instance wrapping this are
 * created via the {@link InstanceStepsFactory} in the {@link TraderStory}.
 */
