...
public class JBehaveBeanDefinitionParser extends AbstractBeanDefinitionParser {
	 ...
	 */
	private static AbstractBeanDefinition parseEmbedderElement(Element element,
			ParserContext parserContext) {
		...
		registerSpringStoryReporterBuilderBean(
				getElementsFromNode(element, OUTPUT_TAG), parserContext);
	 ...
	 */
	private static List<String> getElementsFromNode(Element node, String tagName) {
	 ...
	 */
	private static List<String> getStringValuesFromElementsList(
	 ...
	 */
	private static AbstractBeanDefinition registerLoadFromClasspathBean(Element root,
	 ...
	 * @return created Bean Definition Object.
	 */
	private static AbstractBeanDefinition registerSpringStoryReporterBuilderBean(
	 ...
	 * @return created Bean Definition Object.
	 */
	private static AbstractBeanDefinition registerSpringStoryControlsBean(
			ParserContext parserContext) {
		BeanDefinitionBuilder beanDefinitionBuilder = BeanDefinitionBuilder
	 ...
	 * @return created Bean Definition Object.
	 */
	private static AbstractBeanDefinition registerRegexPrefixCapturingPatternParserBean(
	 ...
	 */
	private static void registerBeanDefinition(ParserContext parserContext,
