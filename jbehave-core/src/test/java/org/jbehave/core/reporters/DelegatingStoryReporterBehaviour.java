...
class DelegatingStoryReporterBehaviour {
    ...
    void shouldDelegateReporterEvents() {
        ...
        String pending = "When step 1.2";
        PendingStep pendingStep = (PendingStep) StepCreator.createPendingStep(pending, null);
        delegator.pending(pendingStep);
        delegator.pending(pending);
        ...
        inOrder.verify(delegate).pending(pending);
