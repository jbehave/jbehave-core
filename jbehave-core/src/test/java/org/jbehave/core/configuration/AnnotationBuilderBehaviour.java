...
public class AnnotationBuilderBehaviour {
    ...
    public void shouldBuildEmbedderWithAnnotatedControls() {
        ...
        assertThat(embedderControls.storyTimeoutInSecsByPath(), equalTo("**/longs/*.story:60,**/shorts/*.story:10"));
    ...
    @UsingEmbedder(batch = true, generateViewAfterStories = true, ignoreFailureInStories = true, ignoreFailureInView = true, skip = true, verboseFailures = true, verboseFiltering = true, storyTimeoutInSecs = 100, storyTimeoutInSecsByPath = "**/longs/*.story:60,**/shorts/*.story:10", failOnStoryTimeout = true, threads = 2)
