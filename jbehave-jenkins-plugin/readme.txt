The JBehave Jenkins plugin can be built with the maven package goal
$ mvn package 
...
* The jbehave-jenkins-plugin depends on the xUnit plugin and requires a minimum of version 1.9 to be installed
* The jbehave-jenkins-plugin.hpi file built by “mvn package” can be installed into Jenkins via the Advanced tab of the “Manage Jenkins > Manage Plugins” screen
