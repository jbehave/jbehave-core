...
import org.jbehave.core.configuration.cdi.ConfigurationProducer.CustomObject;
...
public class CDIAnnotationBuilderBehaviour {
    ...
    private AnnotationBuilder createBuilder(Class<?> type) {
        CDIBootstrap cdi = new CDIBootstrap();
        cdi.initialize();
        AnnotationBuilder builder = cdi.findCDIAnnotationBuilder(type);
